...
def waitingStage(stage, screen):
    global running, global_clicked, start_switch

    # ======================
    global name, flag, process, stdout, BUTTON_verify
    name = ''
    flag = 0
    process = ''
    stdout = ''
...
def AdminStage(stage, screen):
    ...
    cursor_blink_speed = 0.5
    global start_switch, typing_speed, start_time, cursor_visible, cursor_last_toggle
...
def ActAdduser(stage , screen, input_string):
    ...
    if flag == 0:
        ...
        # text = fontIntro.render(stdout, True, (23, 201, 21))
...
def delUser(stage, screen):
    ...
    for i, usr in enumerate(all_user):
        ...
        # screen.blit(text, (310, 340 + i * 35, 500, 500))
...
def chkIntruder(stage, screen):  
    ...
    # text = fontIntro.render(str(all_intruder), True, (23, 201, 21))
    # screen.blit(text, (300, 300))
